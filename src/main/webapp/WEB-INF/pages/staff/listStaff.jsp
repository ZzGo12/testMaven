...
<table width="100%" border="1" >
  <tr class="henglan" style="font-weight:bold;">
    ...
    <s:iterator value="#allStaff" status="vs">
        <%--<s:debug></s:debug>--%>
	  <tr class="<s:property value="#vs.odd? 'tabtd1':'tabtd2'"></s:property> ">
	    <td align="center"><s:property value="staffName"></s:property></td>
	    <td align="center"><s:property value="gender"></s:property> </td>
	    <td align="center"><s:date name="onDutyDate" format="yyyy-MM-dd"></s:date> </td>
	    <td align="center"><s:property value="crmPost.crmDepartment.depName"></s:property></td>
	    <td align="center"><s:property value="crmPost.postName"></s:property></td>
